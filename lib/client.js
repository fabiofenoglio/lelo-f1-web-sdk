...
const leloF1SdkWebClient = {
    ...
    requestDevice: function() {
        ...
        return navigator.bluetooth.requestDevice({
            filters: leloF1SdkConstants.COMPATIBLE_DEVICE_NAMES.map(function(deviceName) {
                return {
                    name: deviceName
                };
            }),
    ...
    connect: function(device) {
        ...
        context.disposing = false;
        context.connecting++;
        context.currentConnectionAttempt = ++context.connectionAttemptProgressive;
        ...
        return device.gatt.connect().then(function(server) {
            ...
            return context._discoverServices(device, server).then(function(result) {
                ...
                // spawn waitForAuthorization promise
                context.waitForAuthorization().then(function() {
                    context.logger.debug('authorization detected');
                });
